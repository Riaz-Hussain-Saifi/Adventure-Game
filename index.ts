  ...
  async function fightGame(opponent: string) {
    ...
    while (userHealth > 0 && opponentHealth > 0) {
      ...
      if (fightAction.action === "Attack") {
        ...
        console.log(
          chalk.redBright(
            `\n${chalk.yellow(inputname)} attacks ${chalk.green(
              opponent
            )}. ${chalk.green(opponent)} loses 10 health.\n`
          )
        );
        ...
        console.log(
          chalk.greenBright(
            `\n${chalk.yellow(inputname)} runs. ${chalk.yellow(
              inputname
            )} gains 5 health.\n`
          )
        );
      ...
      if (opponentAction === "Attack") {
        ...
        console.log(
          chalk.greenBright(
            `\n${chalk.blue(opponent)} runs. ${chalk.blue(
              opponent
            )} gains 5 health.\n`
          )
        );
      ...
      console.log(
        chalk.cyanBright(`${opponent}'s Health: ${opponentHealth}\n`)
      );
    }
